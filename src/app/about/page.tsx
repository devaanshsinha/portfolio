      ...
      <div className="space-y-4">
        ...
        <div className="bg-[var(--console-bg-light)] p-4 sm:p-6 rounded-lg border border-[var(--console-border)]">
          <p className="text-sm sm:text-base text-[var(--console-text)] leading-relaxed mb-4">
            Hello! I&apos;m Devaansh Sinha, a Computer Science student at the
            University of Wisconsin Madison passionate about building innovative
          ...
          <p className="text-sm sm:text-base text-[var(--console-text)] leading-relaxed mb-6">
            With hands-on experience from internships at Gemini and Bajaj
            Finance Direct Limited, I specialize in full-stack development,
            system design, and security. I&apos;ve developed tools serving
            hundreds of thousands of users and built systems that enhance
          ...
          <div className="flex flex-col sm:flex-row items-start gap-4">
            <div className="space-y-2 flex-1">
              ...
              <p className="text-xs sm:text-sm text-[var(--console-text-dim)]">
                BS in Computer Science, Certificate in Game Design
              </p>
              <p className="text-xs sm:text-sm text-[var(--console-text-dim)]">
                Sept 2022 – May 2026 | GPA: 3.9/4.0
              </p>
              <p className="text-xs sm:text-sm text-[var(--console-text-dim)]">
                6-time Dean&apos;s List recipient
              </p>
            </div>
            <Image
